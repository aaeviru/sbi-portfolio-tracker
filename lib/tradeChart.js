...
function attachPriceHistoryToTradeChartData(assets, priceHistoryRows) {
  ...
  assets.forEach(function (asset) {
    ...
    asset.technicalIndicatorSeries = technicalIndicators.buildTechnicalIndicatorSeries(asset, asset.priceHistory);
    asset.technicalIndicators = technicalIndicators.buildTechnicalIndicators(asset, asset.priceHistory);
  });
